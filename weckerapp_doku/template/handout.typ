...
#let dvdtyp(
  ...
  align(center)[
    ...
    #v(0.3em, weak: true)
    #if author != none [#text(14pt)[von #author]]
...
#let codeExample = problem-style("problem", "Syntax Beispiel")

#let theorem-style = builder-thmbox(color: colors.at(6), shadow: (offset: (x: 3pt, y: 3pt), color: luma(70%)))

#let theorem = theorem-style("theorem", "Info")
...
#let explenation = definition-style("definition", "Erklärung")
